...
# - Change sensor address from 2 to 1
#
...
echo ""
echo ""
echo "HYDRA MOISTURE SENSOR - CHANGE SENSOR ADDRESS 2 TO 1"
echo ""

echo ">> 1) Confirm Sensor Address 2"
echo ""
...
echo ""
~/bin/modpoll/modpoll -m rtu -a 2 -r 1 -c 1 -t 4 -b 19200 -d 8 -p none -1 /dev/ttyUSB0 1
echo ""
