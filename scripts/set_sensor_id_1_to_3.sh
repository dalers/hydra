...
# - Change sensor address from 1 to 3
#
...
echo ""
echo ""
echo "HYDRA MOISTURE SENSOR - CHANGE SENSOR ADDRESS 1 TO 3"
echo ""
...
echo ">> 2) Set Sensor Address to 3"
echo ""
~/bin/modpoll/modpoll -m rtu -a 1 -r 1 -c 1 -t 4 -b 19200 -d 8 -p none -1 /dev/ttyUSB0 3
echo ""
...
echo ">> 3) Confirm Sensor Address 3"
echo ""
echo ">>    Read Input Registers"
echo ""
